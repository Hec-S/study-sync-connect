            ...
            <div className="md:ml-12">
              ...
              >
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  >
                    <features[0].icon className={`w-10 h-10 ${features[0].color}`} />
                  </div>
                  <div className="flex-1 text-center md:text-left">
                    <h3 className={`text-2xl font-semibold mb-4 ${user ? 'text-white' : 'text-foreground'}
                      group-hover:${features[0].color} transition-colors duration-300`}
                    >
                      {features[0].title}
                    </h3>
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-2">
                      <span className={`text-sm font-medium ${features[0].color}`}>Learn More</span>
                      <ChevronRight className={`w-4 h-4 ${features[0].color} 
              ...
              >
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  <div className={`p-6 rounded-full ${user ? 'bg-[#041E42]' : 'bg-primary/10'} 
                    transform transition-transform group-hover:scale-110 duration-300`}
                  >
                    <features[1].icon className={`w-10 h-10 ${features[1].color}`} />
                  </div>
                  <div className="flex-1 text-center md:text-left">
                    <h3 className={`text-2xl font-semibold mb-4 ${user ? 'text-white' : 'text-foreground'}
                      group-hover:${features[1].color} transition-colors duration-300`}
                    >
                      {features[1].title}
                    </h3>
                    <p className={`text-lg mb-4 ${user ? 'text-[#B1B3B3]' : 'text-muted-foreground'}`}>
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-2">
                      <span className={`text-sm font-medium ${features[1].color}`}>Learn More</span>
                      <ChevronRight className={`w-4 h-4 ${features[1].color} 
                        transform transition-transform group-hover:translate-x-1`} 
                      />
                    </div>
                  </div>
              ...
              >
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  <div className={`p-6 rounded-full ${user ? 'bg-[#041E42]' : 'bg-primary/10'} 
                    transform transition-transform group-hover:scale-110 duration-300`}
                  >
                    <features[2].icon className={`w-10 h-10 ${features[2].color}`} />
                  </div>
                  <div className="flex-1 text-center md:text-left">
                    <h3 className={`text-2xl font-semibold mb-4 ${user ? 'text-white' : 'text-foreground'}
                      group-hover:${features[2].color} transition-colors duration-300`}
                    >
                      {features[2].title}
                    </h3>
                    <p className={`text-lg mb-4 ${user ? 'text-[#B1B3B3]' : 'text-muted-foreground'}`}>
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-2">
                      <span className={`text-sm font-medium ${features[2].color}`}>Learn More</span>
                      <ChevronRight className={`w-4 h-4 ${features[2].color} 
                        transform transition-transform group-hover:translate-x-1`} 
                      />
                    </div>
                  </div>
